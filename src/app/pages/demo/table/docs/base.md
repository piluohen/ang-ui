...
``` HTML
<ang-table #table [columns]="columns" [data]="tableData" [params]="params" [scroll]="{x: '600px'}" [showPagination]="true" [showSelect]="true" [render]="{linkTemp: linkTemp, operateTemp: operateTemp}">
